					...
					<tr>
						<td style="width: 800px; background: #ffffff;">
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 30px 10px 0 10px;">Hi <?php echo $name; ?>,</td>
								</tr>
								<tr>
								...
								<tr>
									<td style="padding: 10px 10px 0 10px;"><strong>Username :</strong> <?php echo $email; ?></td>
								</tr>
								<tr>
									<td style="padding: 10px 10px 0 10px;"><strong>Password :</strong> <?php echo $password; ?></td>
								</tr>								
								<tr>
